...
@section('content')
    <div style="margin-top:10%">
        ...
        <div class="row justify-content-center" style="margin-bottom:5%">
          @foreach ($buletins->slice(0, 10) as $item)
          <div class="col-md-4 col-sm-12 " >  
            <div class="card" style="height:100%">
                <div class="view overlay">
                  <img class="card-img-top" src="{{ asset('/buletin/'.$item->gambar) }}" style= "width:100%;">
                </div>
                <div class="card-body" >
                    <h4 class="card-title" >
                    {{ $item->judul_buletin }}</h4>
                    <hr>
                    <span>
                    <?php echo $item->judul_buletin ?>
                    <br>
                    <i class="far fa-clock pr-1"></i>
                            05/10/2015
                    </span><br>
                    <a href="/buletinpage/{{ $item->id }}"> <button type="button" class="btn btn-outline-success">Read More</button> </a>  
                </div>    
            </div><br>
      </div>
          @endforeach
